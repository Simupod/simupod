...
class SimulationData:
    ...
    def __init__(self, path: Union[str, Path]):
        ...
        # HDF5 file (simupod.hdf5) / a directory holding one. HDF5 reuses
        ...
        with h5py.File(h5_path, "r") as f:
            ...
            if mj is None:
                raise ValueError(
                    ...
                    "attribute); convert one with simupod.convert_to_hdf5")
    ...
    # -- visualization (simupod.viz; docs/viz-layer-design.md) ------------
    ...
    def plot_field(self, monitor, field="Ex", x=None, y=None, z=None, *,
        ...
        Thin delegation: the rendering lives in :func:`simupod.viz.plot_field`
