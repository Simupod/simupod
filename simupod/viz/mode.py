...
Renders a :class:`simupod.plugins.modes.Mode` (the dominant transverse
...
Consumes the mode's :meth:`~simupod.plugins.modes.Mode.field_dataarray`
...
def plot_mode(mode, *, ax=None, cmap=None, legend=False, **kw):
    """Heatmap of an FDE :class:`~simupod.plugins.modes.Mode`'s transverse
